                ...
                <div class="form-group">
                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Menu</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createMenu" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateMenu" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewMenu" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteMenu" class="minimal"></td>
                      </tr>
                      <tr>
                        <td>Products</td>
