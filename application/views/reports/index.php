    ...
    <section class="content">
        ...
        <div class="row">
          ...
          <div class="col-xs-8 text-right">
              ...
              <h2 class="font-bold"><span class="fa fa-rupee"></span> <?= isset($todays_income[0]->total)?number_format($todays_income[0]->total):0 ?></h2>
          </div>
        </div>
        </div>
        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Total Cafe - Report</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="chart">
