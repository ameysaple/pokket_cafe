                ...
                <div class="form-group">
                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Menu</td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="createMenu" <?php if($serialize_permission) {
                          if(in_array('createMenu', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="updateMenu" <?php if($serialize_permission) {
                          if(in_array('updateMenu', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="viewMenu" <?php if($serialize_permission) {
                          if(in_array('viewMenu', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="deleteMenu" <?php if($serialize_permission) {
                          if(in_array('deleteMenu', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                      </tr>
                      <tr>
                        <td>Products</td>
