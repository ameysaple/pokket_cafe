      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if($user_permission): ?>
          ...
          <?php endif; ?>
           ...
           <?php if(in_array('createMenu', $user_permission) || in_array('updateMenu', $user_permission) || in_array('viewMenu', $user_permission) || in_array('deleteMenu', $user_permission)): ?>
            <li class="treeview" id="mainMenuNav">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <?php if(in_array('createMenu', $user_permission)): ?>
                  <li id="addMenuNav"><a href="<?php echo base_url('menus/create') ?>"><i class="fa fa-circle-o"></i> Add Menu</a></li>
                <?php endif; ?>
                <?php if(in_array('updateMenu', $user_permission) || in_array('viewMenu', $user_permission) || in_array('deleteMenu', $user_permission)): ?>
                <li id="manageMenuNav"><a href="<?php echo base_url('menus') ?>"><i class="fa fa-circle-o"></i> Manage Menus</a></li>
                <?php endif; ?>
              </ul>
            </li>
          <?php endif; ?>
