        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('users/create') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="Mneu_name">Menu name</label>
                  <input type="text" class="form-control" id="menu_name" name="menu_name" placeholder="Enter menu name" autocomplete="off"/>
                </div>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('menus/') ?>" class="btn btn-warning">Back</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
